...
public class PlayerCharacter {
	...
	public PlayerCharacter(String name, int strength, int dexerity){
		this.name = name;
	...
	public int attack(){
		return weapon.attack(this);
	}

	public int dealWeaponDamage(PlayerCharacter p){
		return weapon.damage(p);
	}
	public int defend(){
	...
	public int getDexerityHitModifer(){
		return (dexerity - 10) / 2; 
	}
	public int getStrengthDamageModifer(){
